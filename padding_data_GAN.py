...
questions_file = 'generated_context'#'questions_movie'#'context_simple'
answers_file = 'generated_answer'#'answers_movie'#'answers_simple'
vocabulary_file = 'vocabulary_movie'
padded_questions_file = 'Padded_context_generated'#'Padded_questions_movie'#Padded_context_simple'
padded_answers_file = 'Padded_answers_generated'#'Padded_answers_movie'#'Padded_answers_simple'
unknown_token = 'something'

vocabulary_size = 7000
max_features = vocabulary_size
maxlen_input = 50
maxlen_output = 50  # cut texts after this number of words (among top max_features most common words)
